...
| 6 | **Yes** | No external scripts or styles from CDN. Icons use self-hosted font (@fontsource/material-icons-outlined, bundled). Only bundled framework and library code; no SRI/external resource exposure. |
